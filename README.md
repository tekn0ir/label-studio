# Teknoir Annotation Studio powered by Label Studio
This is a rip-off of Label Studio.
Reskinned and reused for our purposes.

## Build
```bash
gcloud builds submit . --config=cloudbuild.yaml --timeout=3600 --substitutions=SHORT_SHA="pre-release"
```
